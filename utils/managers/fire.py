...
class FireProx(object):
    def __init__(self, arguments, help_text, library=True):
    ...
    def delete_api(self, api_id: str = None):
        if not api_id and not self.api_id:
...
def main():
    ...
    print(args)
    fp = FireProx(args, help_text, library=False)
